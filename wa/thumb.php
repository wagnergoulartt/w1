...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 104857600);					// 100 Megs is 10485760. This is the max internal or external file size that we'll process.  
